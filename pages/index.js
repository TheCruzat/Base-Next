...
import {ContentFrame, ContentWrap, Headline, Center} from "../components/layout";
  ...
  return (
    <div>
        <Head>
            ...
            <meta name="description" content="Dan Cruzat is a web developer, music producer and general digital creative (with wild Tetris skills)." />
